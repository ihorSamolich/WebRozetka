...
import {
    ...
    ListItemButton,
    ListItemIcon,
    ListItemText, FormControlLabel, styled, Switch,
} from "@mui/material";
...
const Header: React.FC<ThemeMode> = (props) => {
    ...
    const MaterialUISwitch = styled(Switch)(({ theme }) => ({
        ...
        '& .MuiSwitch-thumb': {
            backgroundColor: theme.palette.mode === 'dark' ? '#001e3c' : '#00b6ff',
            width: 32,
            height: 32,
            '&:before': {
                content: "''",
    ...
    const mobileMenuItems = () => (
        ...
        >
            <List>
                ...
                <Link to='categories/create' style={{textDecoration: 'none', color: 'inherit'}}>
                    <ListItem disablePadding>
                        <ListItemButton>
                            <ListItemIcon>
